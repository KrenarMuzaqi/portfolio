        ...
        <div className="slider" data-aos="fade-left">
          <Slider {...sliderSettings}>
            <div className="slider-box">
              ...
              <p className="date">{quoutes[0].source}</p>
            </div>
            <div className="slider-box">
              ...
              <p className="date">{quoutes[1].source}</p>
            </div>
            <div className="slider-box">
              ...
              <p className="date">{quoutes[2].source}</p>
            </div>
            <div className="slider-box">
              ...
              <p className="date">{quoutes[3].source}</p>
            </div>
            <div className="slider-box">
              ...
              <p className="date">{quoutes[4].source}</p>
            </div>
          </Slider>
        </div>
      </div>
